...
# Hope to identify trees that have a larger crown than predicted by their stem volume.
...
UAV_Data <- read.csv(file = "LC_2022/2022_UAV_tables/LC_full_complete.csv")

#read in up-to-date growth inventory
