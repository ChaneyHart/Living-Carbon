...
weather_dat_2023_1 <- read.csv("LC_2023/2023_weather/atmos_2023_growing_Season_4_16_7_20.csv",skip = 2, header = T,sep = ',', stringsAsFactors = F)
weather_dat_2023_2 <- read.csv("LC_2023/2023_weather/atmos_2023_growing_Season_7_20_10_16.csv",skip = 2, header = T,sep = ',', stringsAsFactors = F)
