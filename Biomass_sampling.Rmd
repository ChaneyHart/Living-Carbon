...
sample_priority2_SRS <- subset(biomass_random_sample, event_short == "13-15E" | event_short == "CT3" )
...
#5A
#replace LCOR 251 and LCOR 161 due to water bags with 2 other 5A trees
reps_5A <- subset(biomass_replacement_set, event_short =="5A") %>%
  group_by(event_short) %>%
  sample_n(2)

biomass_random_sample_v2 <- subset(biomass_random_sample_v2, ID != "LCOR-251"& ID !="LCOR-161")
...
sample_priority1_SRS_v2 <- subset(biomass_random_sample_v2, event_short == "5A" | event_short == "4A" | event_short == "16-20" | event_short == "8-9D")

write.csv(sample_priority1_SRS_v2,file = "LC_2023/2023_growth_inventory_analysis/biomass_sample_priority1_SRS_v2.csv")

sample_priority2_SRS_v2 <- subset(biomass_random_sample_v2, event_short == "13-15E" | event_short == "CT3" )

write.csv(sample_priority2_SRS_v2,file = "LC_2023/2023_growth_inventory_analysis/biomass_sample_priority2_SRS_v2.csv")
