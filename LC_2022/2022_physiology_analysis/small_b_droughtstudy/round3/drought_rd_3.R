...
predawn_dat_rd3 <- subset(predawn_dat_rd3, select = c(ID,obs,MPa,bar,Fv.Fm,soil.moisture,row,column,event_short,construct,construct2,H421))
...
quenching_dat_1 <- read.csv("2022_physiology_analysis/small_b_droughtstudy/round3/Drought_assimilation_rd3_proc.csv")
quenching_dat_1 <- subset(quenching_dat_1, select = c(ID,A,Ci,gsw,Fs,Fm.,PhiPS2,ETR,PhiCO2,Fo.,Qin,Tleaf))
quenching_dat_2 <- read.csv("2022_physiology_analysis/small_b_droughtstudy/round3/9_22_predawn_li600_rd3_proc.csv")
